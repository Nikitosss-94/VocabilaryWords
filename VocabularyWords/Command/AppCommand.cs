...
namespace VocabularyWords.Command
{
    class AppCommand : ICommand
    {
        ...
        ///     Constructor
        /// </summary>
        public AppCommand(Action executeMethod, Func<bool> canExecuteMethod, bool isAutomaticRequeryDisabled)
        {
    ...
    public class AppCommand<T> : ICommand
    {
        ...
        ///     Constructor
        /// </summary>
        public AppCommand(Action<T> executeMethod, Func<T, bool> canExecuteMethod, bool isAutomaticRequeryDisabled)
        {
            if (executeMethod == null)
            {
                throw new ArgumentNullException("executeMethod");
